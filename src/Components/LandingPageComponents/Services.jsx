...
const Services = () => {
  ...
  return (
    <div
      ref={ref}
      id="services"
      className="bg-[#87ACA3]  md:pb-10 w-full mt-20  px-2 xss:px-4 xs:px-6  sm:px-10  md:px-8  lg:px-10  xl:px-[10rem]  py-[1rem]"
    >
      <motion.p
        className="text-center text-[#F8F8FF] text-3xl font-semibold mt-5 "
      ...
      <div className="grid md:grid-cols-2 mt-10">
        ...
        <motion.div
          className="w-full  card  h-[20rem]  xs:h-[18rem] sm:h-[14rem] md:h-[18rem]  rounded-[14.572px] md:rounded-[23.8886px] relative mb-10 md:mb-0"
          initial={{ opacity: 0, y: 50 }}
          animate={controls}
          transition={{ duration: 1 }}
        >
        ...
        <motion.p
          className="flex justify-center items-center text-sm font-medium text-center  md:text-left leading-[1.5rem] md:pl-20  md:leading-[1.6rem]"
          initial={{ opacity: 0, y: 50 }}
          animate={controls}
          transition={{ duration: 1 }}
        >
